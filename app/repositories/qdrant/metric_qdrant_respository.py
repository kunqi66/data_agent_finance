...
class MetricQdrantResposty:
    collection_name = "data-agent-finance-metric-collection"
    ...
    async def upsert_metric_vectors(self,vectors: list[list[float]], payloads : list[ColumnInfoQdrant], ids: list[str]):
        client = self.client
        collection_name = self.collection_name
